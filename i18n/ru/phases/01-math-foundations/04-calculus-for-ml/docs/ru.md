...
> 🎒 **На пальцах.** Представьте душ с двумя кранами. Вода слишком холодная. Вы не крутите оба крана наугад — вы понимаете, что горячий увеличивает температуру, а холодный уменьшает. Производная и есть это понимание, только для миллиона кранов сразу.
...
> 🎒 **На пальцах.** Снова душ с двумя кранами. «Держим холодный неподвижно, крутим только горячий — что с температурой?» — это частная производная по горячему крану. Мир сложный, но вы разбираете его по одной ручке за раз.
