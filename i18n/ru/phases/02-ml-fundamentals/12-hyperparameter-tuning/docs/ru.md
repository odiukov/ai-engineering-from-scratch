...
> 🎒 **На пальцах.** Игра «горячо-холодно». Random search тычет пальцем наугад и не слушает подсказки. Байесовская оптимизация слушает: после пары «холодно» слева она перестаёт туда ходить и идёт туда, где было «теплее» или где ещё вообще не были. Отсюда и выигрыш в 2-5 раз по числу попыток.
...
> 🎒 **На пальцах.** Правило 80/20 в чистом виде. Если крутить только learning rate, вы уже соберёте большую часть выигрыша. Спорить о том, ставить ли batch size 32 или 64, пока learning rate подобран плохо, — то же самое, что выбирать шрифт в сочинении, не написав текст.
