...
> 🎒 **На пальцах.** Разрыв между кривыми — это «насколько ученик хуже отвечает на новых задачах, чем на решённых». Разрыв огромный — он зубрит, дайте больше задач. Разрыв маленький, но обе кривые внизу — он просто не понял тему, задачи тут не спасут, нужен другой учебник.
...
> 🎒 **На пальцах.** Learning curve меняет количество данных, validation curve — сложность модели. Первая отвечает на вопрос «собирать ли ещё данные», вторая — «крутить ли ручку сложности». Две разные ручки, две разные картинки.
