...
VGG работал на 19 слоях, потому что batch norm (опубликованный одновременно) держал активации в разумном масштабе. Но даже batch norm не спасал глубину дальше примерно 30 слоёв.
