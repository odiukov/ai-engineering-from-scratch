...
> 🎒 **На пальцах.** Ключевое слово — «аддитивно». Складывать безопасно: сто раз прибавить 0.1 к нулю — получите 10. Умножать опасно: сто раз умножить на 0.9 — получите почти ноль. Cell state в LSTM — это конвейерная лента, на которую информацию добавляют, а не перемножают заново на каждом шаге.
