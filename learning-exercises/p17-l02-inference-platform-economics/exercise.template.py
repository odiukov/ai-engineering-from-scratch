"""
Экономика inference-платформ: per-token, per-minute и точка окупаемости
...
Запуск:  ./learning-exercises/watch.sh p17-l02-inference-platform-economics
Разбор:  /check-code p17-l02-inference-platform-economics
"""
