"""
Context engineering: бюджет окна, порядок, память
...
Запуск:  ./learning-exercises/watch.sh p11-l05-context-engineering
Разбор:  /check-code p11-l05-context-engineering
"""
