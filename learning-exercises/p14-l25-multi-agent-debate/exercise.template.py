"""
Multi-agent debate: дебаты и коллаборация агентов
...
Запуск:  ./learning-exercises/watch.sh p14-l25-multi-agent-debate
Разбор:  /check-code p14-l25-multi-agent-debate
"""
