"""
Диффузионные трансформеры и rectified flow
...
Запуск:  ./learning-exercises/watch.sh p04-l23-diffusion-transformers-rectified-flow
Разбор:  /check-code p04-l23-diffusion-transformers-rectified-flow
"""
