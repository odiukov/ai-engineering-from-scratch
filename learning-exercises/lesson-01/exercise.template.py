"""
Урок 01 — Интуиция линейной алгебры.

Реализуй функции ниже. Векторы — обычные списки чисел: [3, 2].
Матрицы — списки строк: [[0, -1], [1, 0]].

Правила:
  * numpy НЕ использовать. Смысл упражнения — собрать руками.
  * из math можно всё.
  * файл test_exercise.py не трогай.

Пока функция не написана, она бросает NotImplementedError и тест краснеет.
Удали строку raise и напиши код.
"""
