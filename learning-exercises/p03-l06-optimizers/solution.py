...
def adam_step(params, grads, m, v, t, lr=0.001, beta1=0.9, beta2=0.999, eps=1e-8):
    ...
    Обрати внимание на пример: на первом шаге поправки сокращают друг
    друга и шаг равен ровно lr, независимо от величины градиента. В этом
    и смысл Adam — размер шага задаёт lr, а градиент только направление.
...
def run_adam(grad_fn, start, lr, steps):
    ...
    величины градиента, Adam — ровно 0.9, потому что шагает на lr.
