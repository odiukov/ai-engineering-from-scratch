"""
Ландшафт кодовых агентов: сравнение по осям возможностей
...
Запуск:  ./learning-exercises/watch.sh p15-l09-coding-agent-landscape
Разбор:  /check-code p15-l09-coding-agent-landscape
"""
