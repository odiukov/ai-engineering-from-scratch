...
- [OpenAI: Akkaya et al. (2019). Solving Rubik's Cube with a Robot Hand](https://arxiv.org/abs/1910.07113) — Dactyl; the paper that introduced Automatic Domain Randomization (ADR) and ran it at scale.
